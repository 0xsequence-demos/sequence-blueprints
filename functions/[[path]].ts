...
// export const remixHandler = createPagesFunctionHandler();
...
// const cacheDefaultTTL = 300; // 5 minutes
// const cacheStaleWhileRevalidateTTL = 86400 * 2; // 2 days in seconds
...
//   // for its layer.
//   response.headers.set("cdn-cache-control", `max-age=${cacheDefaultTTL}`);
